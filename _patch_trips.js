...
const heading = '<h2 className="text-xl mb-3">Danh sA?ch chuy???n xe</h2>';
const headingIndex = text.indexOf(heading);
if (headingIndex === -1) {
  throw new Error('Heading not found');
}
const start = text.lastIndexOf('      <div className="card p-3">', headingIndex);
if (start === -1) {
  throw new Error('Start card not found');
}
const endMarker = '\r\n\r\n\r\n      {cancelTripTarget && (';
const end = text.indexOf(endMarker, headingIndex);
if (end === -1) {
